...
class VfTwo():
    ...
    def __init__(self, g, h):
        ...
        '''general question: is it more expensive to reassign values to
        variables or to check with ifs before assigning any value?'''
    ...
    def compute_p(self):
        ...
        '''The "vals" are a bit confusing to me. What is the benefit of working
        with a list here? A dict should be faster and more self-explaining.'''
    ...
    def cart_prod(self, nodes, my_max):
        ...
        for v in nodes:
            cart_p.add((v, my_max))
        print("candidates {}".format(cart_p))
        return cart_p

    '''Can v ever be null_n? '''
